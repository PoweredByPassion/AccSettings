...
class ToolsScreenTest {
    ...
    fun chineseLocale_usesLocalizedStaticText() {
        ...
        composeRule.onNodeWithText(context.getString(app.owlow.accsettings.R.string.tools)).assertExists()
        composeRule.onNodeWithText(context.getString(app.owlow.accsettings.R.string.tools_intro)).assertExists()
    }
}
