package app.owlow.accsetting.data

import android.content.Context
import android.util.Log
import androidx.preference.PreferenceDataStore
import app.owlow.accsetting.R
import app.owlow.accsetting.acc.AccBridge
import app.owlow.accsetting.acc.AccCapability
import app.owlow.accsetting.acc.AccDraftState
import app.owlow.accsetting.acc.AccProbeFacts
import app.owlow.accsetting.acc.ApplyGroupedPatchRequest
import app.owlow.accsetting.acc.ApplyGroupedPatchResult
import app.owlow.accsetting.acc.CapacityConfig
import app.owlow.accsetting.acc.CapacityMode
import app.owlow.accsetting.acc.Command
import app.owlow.accsetting.acc.ConfigGroupMode
import app.owlow.accsetting.acc.DraftStatus
import app.owlow.accsetting.acc.GroupApplyWriteResult
